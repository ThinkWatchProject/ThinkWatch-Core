...
pub fn finding_view(f: &tw_scan::report::Finding) -> tw_api::ScanFinding {
    tw_api::ScanFinding {
        ...
        rule: f.rule.clone(),
        kind: match f.kind {
            tw_scan::sources::Kind::Hooks => tw_api::ScanSource::Hooks,
            tw_scan::sources::Kind::Mcp => tw_api::ScanSource::Mcp,
            tw_scan::sources::Kind::Skill => tw_api::ScanSource::Skill,
            tw_scan::sources::Kind::Command => tw_api::ScanSource::Command,
            tw_scan::sources::Kind::Agent => tw_api::ScanSource::Agent,
            tw_scan::sources::Kind::Instructions => tw_api::ScanSource::Instructions,
        },
